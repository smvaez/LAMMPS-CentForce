...
AtomVecBondxo::AtomVecBondxo(LAMMPS *lmp, int narg, char **arg) :
...
void AtomVecBondxo::copy(int i, int j, int delflag)
{
  int k;
...
int AtomVecBondxo::pack_comm(int n, int *list, double *buf,
...
int AtomVecBondxo::pack_comm_vel(int n, int *list, double *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecBondxo::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecBondxo::unpack_comm_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecBondxo::pack_reverse(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecBondxo::unpack_reverse(int n, int *list, double *buf)
{
  int i,j,m;
...
int AtomVecBondxo::pack_border(int n, int *list, double *buf,
                             int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecBondxo::pack_border_vel(int n, int *list, double *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecBondxo::pack_border_hybrid(int n, int *list, double *buf)
{
  int i,j,m;
...
void AtomVecBondxo::unpack_border(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecBondxo::unpack_border_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecBondxo::unpack_border_hybrid(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecBondxo::pack_exchange(int i, double *buf)
{
  int k;
...
int AtomVecBondxo::unpack_exchange(double *buf)
{
  int k;
...
int AtomVecBondxo::size_restart()
{
  int i;
...
int AtomVecBondxo::pack_restart(int i, double *buf)
{
  int k;
...
int AtomVecBondxo::unpack_restart(double *buf)
{
  int k;
...
void AtomVecBondxo::create_atom(int itype, double *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecBondxo::data_atom(double *coord, int imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
int AtomVecBondxo::data_atom_hybrid(int nlocal, char **values)
{
...
bigint AtomVecBondxo::memory_usage()
{
  bigint bytes = 0;
